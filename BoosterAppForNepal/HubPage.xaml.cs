...
namespace BoosterAppForNepal
{
    ...
    public sealed partial class HubPage : Page
    {
        ...
        {
            if(logId.Text =="joon" && pwdCheck.Password=="joon"  )
            {
                this.Frame.Navigate(typeof(UnicefPage));
            }
            else if (logId.Text == "9841895794" && pwdCheck.Password == "123")
            {
        ...
        {
            this.Frame.Navigate(typeof(instant));
        }
